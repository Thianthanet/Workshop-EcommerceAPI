/*
  ...
  - Added the required column `stripPaymentId` to the `Order` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `order` ADD COLUMN `amount` INTEGER NOT NULL,
    ...
    ADD COLUMN `stripPaymentId` VARCHAR(191) NOT NULL;
